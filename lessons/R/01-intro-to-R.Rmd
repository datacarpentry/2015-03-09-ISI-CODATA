...
_variables_. To create a variable, we need to give it a name followed by the
...
strong opinions about which is better.  In most situations it's really a matter of preference.
