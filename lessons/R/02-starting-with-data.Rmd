...
* if you have not already in a previous lesson, [download the data file](../../data/biology/surveys.csv)
...
therefore require some attention. We will talk about data frames in more detail
in the next lesson.
...
***Question: How can you recreate this plot but having "control" being listed last instead of first?***

```{r, results='show', purl=TRUE}
## Create a barplot, but without controling the order of the factors
...
Previous: [Introduction to R](01-intro-to-R.html)  Next: [Data Frames](03-data-frames.html)
